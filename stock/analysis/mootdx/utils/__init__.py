...
from analysis.mootdx.consts import MARKET_BJ
from analysis.mootdx.consts import MARKET_SH
from analysis.mootdx.consts import MARKET_SZ
...
def to_data(v, **kwargs):
    ...
    if adjust and adjust in ['qfq', 'hfq'] and symbol:
        from analysis.mootdx.utils.adjust import to_adjust
