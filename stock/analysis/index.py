...
class IndexSSB(object):
    ...
    def __make_charts_min(self):
        ...
        df_index_ssb_min_today = df_index_ssb_min[
            (df_index_ssb_min.index.year == dt_trading_last_T0.year)
            & (df_index_ssb_min.index.month == dt_trading_last_T0.month)
            & (df_index_ssb_min.index.day == dt_trading_last_T0.day)
        ]
