...
import datetime
from analysis.tushare.pro import client
from analysis.tushare.util import upass
from analysis.tushare.util.formula import MA
from analysis.tushare.subs.ts_subs import Subs
        ...
        try:
            if asset == 'E':
                ...
                if adj is not None:
                    ...
                    data['adj_factor'].bfill(inplace=True)
...
def ht_subs(username, password):
    from analysis.tushare.subs.ht_subs import Insight
