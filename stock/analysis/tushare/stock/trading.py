...
import numpy as np
import datetime
from analysis.tushare.stock import cons as ct
import re
from analysis.tushare.util import dateu as du
from analysis.tushare.util.formula import MA
import os
from analysis.tushare.util.conns import get_apis, close_apis
from analysis.tushare.stock.fundamental import get_stock_basics
try:
...
def reset_instrument(xapi=None):
    """
            重新设置本地证券列表
    """
    import analysis.tushare.util.conns as cs 
